...
public final class ErrorLog {
     ...
     * localization dictionary of the application, and is translated accordingly
     * before the error message is stored internally.
     *
     ...
     *
     * @param message The error or warning message. If the message starts with a
     * hash mark (<code>#</code>) it is assumed that the message is a key in the
     * localization dictionary. This is then equivalent to invoking the
     * following code:
     *
    ...
    /**
     * Merges errors and warnings from another error log into this one. Does not
     * affect the other error log.
     *
    ...
    /**
     * Test whether there are any errors or warnings of a given degree of
     * severity.
     *
     * @param severity The degree of severity, see {@link Severity} for an
     * explanation of the different degrees.
     * @return <code>true</code> if errors of the given degree of severity
