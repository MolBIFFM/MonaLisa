 ...
 * element of the list. In this way it is ensured that when a colored marking 
 * of the node is removed, the right color of the node remains.
 * 
 * @author daniel
 */
...
public class ColorMap {
    ...
    /**
     * Returns the Color of the specified node. This is always the last Color
     * in the colorList of the node. If the colorList of the node is empty 
