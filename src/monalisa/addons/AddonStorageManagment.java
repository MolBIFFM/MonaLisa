...
/**
 * The Interface needed by a AddOn to store data in the project file and receive
 * those data.
 *
 * @author jens
 */
public interface AddonStorageManagment {
    ...
    /**
     * Provides a map of the objects with their identifier, which should be
    ...
    /**
     * This function is called, after the project is loaded and gives the Addon
     * class their stored data back.
     *
     * @param storage
     */
