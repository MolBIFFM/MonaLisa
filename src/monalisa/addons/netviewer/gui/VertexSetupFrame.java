...
public class VertexSetupFrame extends javax.swing.JFrame {
    ...
    /**
     * Create a new setup frame for a single NetViewerNode at a given point on
     * the screen
     *
     * @param netViewer
     * @param nvNode
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        ...
        boolean error = false;
        if (nvNodes.size() == 1) {
            error = !netViewer.writeVertexSetup(nvNodes.get(0), showColorLabel.getForeground(), showStrokeColorLabel.getForeground(), vertexNameTextField.getText(), tokens, vertexNoteTextArea.getText(), lablePosition, (Compartment) compartmentCb.getSelectedItem());
        } else {
