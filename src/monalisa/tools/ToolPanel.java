 ...
 * a corresponding tool.<b>Note to implementors:</b> A panel should be created
...
public interface ToolPanel {
    ...
    /**
     * Should always return the class of the tool the ToolPanel is associated with.
     * @return Class of the associated tool.
     */
    Class<? extends Tool> getToolType();

    /**
     * Returns whether this panel's tool should be executed (i.e.whether the user has
