 ...
 * it.
 */
public class TokensimPopupMousePlugin extends AbstractPopupGraphMousePlugin implements MouseListener {

    private final VisualizationViewer<NetViewerNode, NetViewerEdge> vv;
    private final PetriNetFacade pnf;
    private final static Logger LOGGER = LogManager.getLogger(TokensimPopupMousePlugin.class);
    private final AbstractTokenSim ats;

    public TokensimPopupMousePlugin (VisualizationViewer<NetViewerNode, NetViewerEdge> vv, PetriNetFacade pnf, AbstractTokenSim ats) {
        this.vv = vv;
        this.pnf = pnf;
        this.ats = ats;
    }
                    ...
                    popup.add(new AbstractAction(TokenSimulator.strings.get("TSSetTokens")) {
                        ...
                        public void actionPerformed(ActionEvent e) {
                            try {
                                ...
                                if (tokens >= 0) {
                                    ats.getTokenSim().setTokens(place.id(), tokens);
                                }
                    ...
                    popup.add(new AbstractAction(TokenSimulator.strings.get("TSSetTokens")) {
                        ...
                        public void actionPerformed(ActionEvent e) {
                           ...
                           Create new frame for math exp.
                             */
                            MathExpFrame frame;
                            frame = new MathExpFrame(pnf.places(), ats.getTokenSim().getMathematicalExpression(place.id()));
                           ...
                           The information is the id of the place for which the mathematical expression is created. Used in the listener.
                             */
                            frame.addListener(ats, place.id());
                ...
                * Add checkbox item for selecting whether the place is constant (i.e. the number of tokens on it will not be modified by simulators)
                ...
                cbItem.addItemListener(new ItemListener() {
                    ...
                    public void itemStateChanged(ItemEvent e) {
                        ats.getTokenSim().setPlaceConstant(place.id(), cbItem.isSelected());
                    }
                });
                popup.add(cbItem);
