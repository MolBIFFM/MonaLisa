...
public final class Place extends UniquePetriNetEntity implements Comparable<Place> {
    ...
    /**
     * If a place is declared constant, the number of tokens on this place
     * should not be changed by simulators. No tokens should be added to or
     * removed from it. Can be used to model a constant input.
     */
     ...
     *
     * @return true if number of tokens remains constant, false if number of
     * tokens can be altered during simulations.
     */
    ...
    /**
     * Set the constant state to true, if the number of tokens on this place
     * should not be modified by simulators.
     *
     * @param cons
     */
