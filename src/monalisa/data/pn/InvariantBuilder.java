...
public final class InvariantBuilder {
    ...
    /**
     * Set the identifier of the Invariant. Since the builder is agnostic of
     * other existing invariants, it does not check whether the identifier is
     * really unique. This is the responsibility of the user of this class.
     *
     ...
     * Invariant. If the factor of the transition is <code>0</code>, it is not
     * added to the Invariant. Negative factors are invalid but are
     * <em>not</em> checked for.
     *
     * @param ObjectId The unique identifier of the Object.
     * @param factor The factor of the transition or place in the Invariant
     * vector.
     * @return Returns a reference to this builder instance.
     * @throws InvalidIdException Thrown when the transition identifier does not
     * exist in the associated Petri net.
     */
    ...
    /**
     * Adds a transition or place to the Invariant. If the factor of the
     * transition is <code>0</code>, it is not added to the Invariant. Negative
     * factors are invalid but are <em>not</em> checked for.
     *
     ...
     * no transition or place information. It ignores whether an ID for the
     * Invariant has already been set.
     */
    ...
    /**
     * Creates and returns a new Invariant based on the information collected in
     * the builder. Subsequent calls to this method will create new instances.
     * Subsequent changes to this builder instance are <em>not</em> carried over
     * to the Invariant.
     *
    ...
    /**
     * Clears the builder instance. After a call to this method its status is as
     * just after construction, and {@link #isEmpty()} will return
     * <code>true</code>.
     */
    public void clear() {
        if (InvType.equals("PI")) {
    ...
    /**
     * Creates and returns a new Invariant based on the information collected in
     * the builder. Clear the builder afterwards so that it can be reused to
