...
/**
 * A P-Invariant in a Petri net.
 * Use the {@link PInvariantBuilder} class to create P-Invariants.
...
public class PInvariant implements Serializable, Set<Place> {
    ...
    /**
     * <p>Creates a new P-Invariant with an identifier and a list of weighted
     ...
     * @param id The identifier of the P-Invariant. It should be unique for
     *          each Petri net.
    ...
    /**
     * Returns a vector of the transition factors in this P-Invariant, over
     * all transitions of the associated Petri net, sorted by their ID.
     * Transitions not occurring in the P-Invariant have factor 0.
