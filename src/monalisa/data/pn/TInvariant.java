...
/**
 * A T-invariant in a Petri net. Use the {@link TInvariantBuilder} class to
 * create T-invariants.
 *
...
public class TInvariant implements Serializable, Set<Transition> {
    ...
    /**
     * <p>
     * Creates a new T-invariant with an identifier and a list of weighted
     ...
     *
     * @param id The identifier of the T-invariant. It should be unique for each
     * Petri net.
    ...
    /**
     * Returns a vector of the transition factors in this T-invariant, over all
    ...
    /**
     * <p>
     * Returns whether the T-invariant is trivial. A T-invariant is
     * <em>trivial</em> if and only if it contains exactly two transitions which
     * are exact opposites, i.e. the inputs of the one are the outputs of the
     * other, and vice versa.</p>
     * <p>
     * In systems biology terms, this corresponds to a reversible reaction.</p>
     *
     * @return Returns <code>true</code> if the T-invariant is trivial,
     * <code>false</code> otherwise.
     * @see "Marco Bernardo, Pierpaolo Degano, Gianluigi Zavattaro (Editors),
     * <em>Formal Methods for Computational Systems Biology</em>, Springer
     * (2008), p231."
     */
