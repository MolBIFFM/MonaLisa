...
public class TokenSimPreferencesJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle(TokenSimulator.strings.get("TSPREFtitle"));
        ...
        createLogJCheckBox.setText(TokenSimulator.strings.get("TSPREFcreateLogJCheckBox"));
        createLogJCheckBox.setToolTipText(TokenSimulator.strings.get("TSPREFcreateLogJCheckBoxT"));
        ...
        logPathJTextField.setToolTipText(TokenSimulator.strings.get("TSPREFlogPathJTextFieldT"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        logPathBrowseJButton.setText(TokenSimulator.strings.get("Browse"));
        logPathBrowseJButton.setToolTipText(TokenSimulator.strings.get("TSPREFlogPathBrowseJButtonT"));
        ...
        okJButton.setToolTipText(TokenSimulator.strings.get("TSPREFokJButtonT"));
        ...
        cancelJButton.setText(TokenSimulator.strings.get("Cancel"));
        cancelJButton.setToolTipText(TokenSimulator.strings.get("TSPREFcancelJButtonT"));
        ...
        snapshotsCB.setText(TokenSimulator.strings.get("TSSnapshotsCB"));
        snapshotsCB.setToolTipText(TokenSimulator.strings.get("TSSnapshotsTT"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        ...
        chartPlottingCB.setText(TokenSimulator.strings.get("TSPREFEnablePlottingCB"));
        chartPlottingCB.setToolTipText(TokenSimulator.strings.get("TSPREFEnablePlottingTT"));
    ...
    private void logPathBrowseJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_logPathBrowseJButtonActionPerformed
        ...
        int returnVal = fileChooser.showDialog(this, TokenSimulator.strings.get("TSPREFchooseDirectory"));
