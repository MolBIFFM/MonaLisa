...
public class Utilities {
    ...
    /**
     * Computes natural logarithm of gamma function of n. Used for calculating
     * factorials, since n! = gamma(n+1). See William et al. (1999) Numerical
     * Recipes in C, Second Edition. Cambridge University Press, 6.1: 213-214.
     *
     * @param n
     * @return
     */
    ...
    /**
     * Compute the factorial of given integer. Call this function only for i
     * &lq= 20. Otherwise, use the natural logarithm of i! by calling
     * factorialln(i). This is necessary because factorials of i greater than 20
     * are too big for a Long.
     *
     * @param i &lq20
    ...
    /**
     * Calculate natural logarithm of factorial of i. Used for calculating
    ...
    /**
     * Calculate the binomial coefficient n choose k. n choose k = n! /
     * (k!*(n-k)!).
     *
     * @param n
     * @param k
    ...
    /**
     * Convert a number of seconds to the readable string representation if
