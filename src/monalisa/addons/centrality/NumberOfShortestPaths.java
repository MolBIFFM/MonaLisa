...
/**
 * This class computes for every node the number of shortest paths which pass
 * through it and stores the number of shortest paths for each node combination
 * in a matrix
 *
...
public class NumberOfShortestPaths {
     ...
     * the number of shortest paths is computed, which pass through a certain
     * node. This is done for every node
     *
     * @param adjMatrix
     * @param floydWarshall
     */
    ...
    /**
     * Yields the number of shortest paths for each combination of nodes in a
     * matrix
     *
