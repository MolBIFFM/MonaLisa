...
/**
 * Any single result produced by a {@link Tool}. Results hold data and can be
 * exported. Every possible result type of a tool should implement this
 * interface.
 *
...
public interface Result extends Serializable {
     ...
     * @param config The exact configuration belonging to this result. To avoid
     * redundancies, configurations should <em>not</em> be stored inside the
     * result, therefore they are passed to this method.
