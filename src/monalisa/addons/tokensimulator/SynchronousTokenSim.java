...
public class SynchronousTokenSim extends AsynchronousTokenSim{
    ...
    /**
     * Compute what transitions will fire in next step. This will check every active transitions. Is a transitions is not concurrent with other transitions,
     * i.e. it does not share a pre-place with other transitions, it will fire. If a transitions shares a pre-place with another transition, and the token number
     * on the pre-place is insufficient to fire both concurrent transitions, decide randomly which transitions will fire.
     * @return 
     */
