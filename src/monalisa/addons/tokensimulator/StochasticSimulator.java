...
//    private final OutputProcessor outputProcessor = new OutputProcessor();
    ...
    //BEGIN INNER CLASSES
    /**
     * This runnable is used to start an exact stochastic simulation. Every
     * reaction occurrence will be simulated. Good for small molecule numbers
     * with observable stochastic effects, but very slow with large molecule
     * numbers. It is possible to start several threads with the instances of
     * this class, so several simulations of the same system will run parallel.
     */
    protected class ExactSSA implements Runnable {
         ...
         * values are corresponding reaction rates. Reactions which rates are 0
         * are not stored.
         */
        ...
        /**
         * Save the index of reactions rates should be updated. Only update
         * rates of reactions which are dependent of compounds with changed
         * molecule numbers.
         */
        ...
        /**
         * This method is used to write the current state of simulation run
         * (number of simulated steps and simulated time) to the outTextArea.
         */
         ...
         * Petri net and update the visual output of the PN. Also update the
         * time counter of TokenSimulator.
         */
        ...
        /**
         * Creates a window with results of selected places plotted with
         * JFreeChart. Results are read from the output file.
         *
        ...
        /**
         * Compute the rate of the reaction with index idx at current state. If
         * the reaction does not have required amount of educts, its reaction
         * rate is set to 0.
         *
